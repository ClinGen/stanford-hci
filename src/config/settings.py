"""
This module provides the Django settings for the HCI. Some of it is boilerplate,
and some of it has been customized for the HCI.
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "hci"),
        "USER": os.getenv("POSTGRES_USER", "hci"),
